  ...
  return (
    <div className="main-container next">
      ...
      <div className="flex-item-22">
        <div className="white-paper-main-extract extract-reduce">
          <div className="extract-header">
            <div className="de-item">
              <p className="label-de">REFRESH TIME</p>
              <Select
                // className="select-extract"
          ...
          {/* table content */}
          <div className="main-container flex-item-2-extract">
            <div className="FixedHeightContainer annex">
...
export default DataMainSideNav;
